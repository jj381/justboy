...
printf "\e[1;95m   
 ...
 ██▄█▀  ▀█▄█▀   ▀█                                                            
               ...
               ▀▀                     \e[0m\n"
printf "\n"
printf " Instagram Brute Forcer v1.0, Author: Just a boy (اللهم صل على محمد وال محمد) \n telegram : https://t.me/cybersuco " 
printf "\n"
}
function start() {
sleep 2
clear
read -p $'\e[1;92mUsername account (يوزر الحساب ): \e[0m' user
...
read -p $'\e[1;92mPassword List (ملف كلمات المرور): \e[0m' wl_pass
